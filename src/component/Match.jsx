...
const Squad = ()=>{
    ...
    return (
        <>
           <div className="squad">
           <input type="Numder" min="1" max="25" placeholder="numder of teams" value = {squad} onChange={onChange}/>
...
const Duo = ()=>{
    ...
    return (
        <>
         <div className="squad">
         <input type="Numder" placeholder="numder of teams" value = {duo} onChange={onChange}/>
...
const Solo = ()=>{
    return (
        <>
       <div className="squad">
       <input type="Numder" placeholder="total players" value={solo} onChange={(e)=>{setsolo(e.target.value)}} />
       </div>
        </>
    )
}
...
return (
 <>
   ...
   <label htmlFor=""> Map </label>
    ...
    <input type="text" name="Room_name" placeholder="enter the room name" value={normal.Room_name} onChange={normalData} />
...
const Advance = ()=>{
    ...
    <input type="text" name="Room_name" placeholder="enter the room name" value={advance.Room_name} onChange={advanceData} />
        <br/>
      <hr />
          ...
          <h4>Parameters</h4>
           <label> playZone shrink speed </label>
            ...
            <select name="sound_visualization" onChange={advanceData} value={advance.sound_visualization} >
                <option > sound_visualization</option>
              <option value="on">on </option>
              <option value="off">off</option>
               </select>

            <select name="open_door" onChange={advanceData} value={advance.open_door} >
                <option > Auto open_door</option>
              <option value="on">on </option>
              <option value="off">off</option>
               </select>
            
               <select name="auto_pick" onChange={advanceData} value={advance.auto_pick} >
                <option > auto_pick</option>
              <option value="on">on </option>
              <option value="off">off</option>
               </select>
               <select name="Red_zone" onChange={advanceData} value={advance.Red_zone} >
                <option > Red_zone</option>
              <option value="on">on </option>
              <option value="off">off</option>
               </select>
               <select name="Aim_assist" onChange={advanceData} value={advance.Aim_assist} >
...
const Esports = ()=>{
    ...
    return (
        ...
        {/*   this is for drop down  levels  */}
           ...
           <div className="level">
           <p> Levels</p>
            <select id="dropdown" onChange={(e)=>{setdropdown(e.target.value)}}>
         ...
         <section onChange={(e)=>{setcustom(e.target.value)}} >
                <h4>Custom Room</h4>
                <input type="radio" value="Normal" name="customRomm" /> Normal Room
                 <input type="radio" value="Advance" name="customRomm" /> Advance Room
                <input type="radio" value="Esports" name="customRomm" /> Esports Room
                <br />
